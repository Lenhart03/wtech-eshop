...
<body>
    ...
    <div style="height: calc(100vh - 80px - 72px - 40px); max-height: calc(100vh - 80px - 72px - 40px); display: flex; flex-direction: column; gap: 20px; align-items: center;" id="content">
